...
namespace MauiWifiManager
{
    ...
    {
        private static Lazy<IWifiNetworkService> _Implementation = new(() => CreateWifiManager(), LazyThreadSafetyMode.PublicationOnly);
    ...
    public static class Initialize
    {
        ...
        public static MauiAppBuilder UseMauiWifiManager(this MauiAppBuilder builder)
        {
            ...
            builder.ConfigureLifecycleEvents(events =>
            {
                ...
                {                    
                    WifiNetworkService.Init(Platform.CurrentActivity);
                }));
            });
