...
namespace MauiWifiManager
{
    ...
    public class WifiNetworkService : IWifiNetworkService
    {
        ...
        /// Get Network Info
        /// </summary>
        public Task<WifiManagerResponse<NetworkData>> GetNetworkInfo(System.Threading.CancellationToken cancellationToken = default)
        {
            var response = new WifiManagerResponse<NetworkData>();
        ...
        /// Scan Wi-Fi Networks
        /// </summary>
        public async Task<WifiManagerResponse<List<NetworkData>>> ScanWifiNetworks(System.Threading.CancellationToken cancellationToken = default)
        {
